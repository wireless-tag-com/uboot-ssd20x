...
void HalDispMopgInit(void)
{
    ...
    W2BYTEMSK(REG_DISP_MOPG_BK0_04_L, 0x3D, 0x00FF);//h04 [7:0]ymd_thd
    W2BYTEMSK(REG_DISP_MOPG_BK0_05_L, 0x3D, 0x00FF);//h05 [7:0]cdma_thd; default=0xf8, use 0xd0 for patch
...
void HalDispMopsInit(void)
{
    ...
    W2BYTEMSK(REG_DISP_MOPS_BK0_04_L, 0x3D, 0x00FF);//h04 [7:0]ymd_thd
    W2BYTEMSK(REG_DISP_MOPS_BK0_05_L, 0x3D, 0x00FF);//h05 [7:0]cdma_thd; default=0xf8, use 0xd0 for patch
