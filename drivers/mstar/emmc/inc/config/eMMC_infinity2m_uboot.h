...
*
* Author: jianghe.xu <jianghe.xu@sigmastar.com.cn>
*
...
#define BIT_BOOT_CLK_SRC_SEL            BIT3
...
#define PAD_CHIPTOP_BASE                GET_REG_ADDR(RIU_BASE, REG_BANK_CHIPTOP) //CHIPTOP OR PADTOP
#define PAD_PADTOP_BASE                 GET_REG_ADDR(RIU_BASE, REG_BANK_PADTOP) //CHIPTOP OR PADTOP

#define reg_emmc_rstz_en                GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x13) //[B3]reg_emmc0_rst_mode [B7:B6] reg_emmc1_rst_mode
...
#define BIT_SD_MODE_MASK                (BIT8|BIT9)
