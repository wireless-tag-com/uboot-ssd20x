...
U32 eMMC_CheckIfMemCorrupt(void)
{
    ...
    return eMMC_ST_SUCCESS;
      ...
      (defined(eMMC_DRV_INFINITY2M_UBOOT)&&eMMC_DRV_INFINITY2M_UBOOT)
...
#elif (defined(eMMC_DRV_INFINITY2M_UBOOT)&&eMMC_DRV_INFINITY2M_UBOOT)
...
U32 eMMC_clock_setting(U16 u16_ClkParam)
{
    ...
    //}
    REG_FCIE_SETBIT(reg_ckg_fcie, BIT_FCIE_CLK_SRC_SEL);
    REG_FCIE_SETBIT(reg_sc_gp_ctrl, BIT_BOOT_CLK_SRC_SEL); //reg_ckg_sd [B3]SDIO30 [B7]SD30
