...
static ST_WRITE_PROTECT _pstWriteProtectTable_GM25Q128A[] =
{
    ...
    {   BITS(6:2, 6),   0x00800000,     0x00FFFFFF  },
    ...
    {   BITS(6:2, 17),  0x00FFF000,     0x00FFFFFF  },
    {   BITS(6:2, 18),  0x00FFE000,     0x00FFFFFF  },
    {   BITS(6:2, 19),  0x00FFC000,     0x00FFFFFF  },
    {   BITS(6:2, 20),  0x00FF8000,     0x00FFFFFF  },
    {   BITS(6:2, 25),  0x00000000,     0x00000FFF  },
    {   BITS(6:2, 26),  0x00000000,     0x00001FFF  },
    {   BITS(6:2, 27),  0x00000000,     0x00003FFF  },
    {   BITS(6:2, 28),  0x00000000,     0x00007FFF  },
...
hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_EN25QX128A,  MID_EON,    0x71,   0x18,   NULL,                                 NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,    BITS(5:2, 0x0F),    ISP_DEV_PMC,        ISP_SPI_ENDIAN_LITTLE, {E_SPI_54M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
